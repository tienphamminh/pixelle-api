...
class PersistenceService:
    ...
    def _config_to_dict(self, config: StoryboardConfig) -> Dict[str, Any]:
        ...
        return {
            ...
            "image_motion_preset": config.image_motion_preset,
    ...
    def _dict_to_config(self, data: Dict[str, Any]) -> StoryboardConfig:
        ...
        return StoryboardConfig(
            ...
            image_motion=data.get("image_motion", "static"),
            image_motion_strength=data.get("image_motion_strength", "subtle"),
            image_motion_preset=data.get("image_motion_preset", "auto"),
            subtitle_mode=data.get("subtitle_mode", "scene"),
            subtitle_style=data.get("subtitle_style", "comic_tiktok"),
            subtitle_words_per_chunk=data.get("subtitle_words_per_chunk", 4),
