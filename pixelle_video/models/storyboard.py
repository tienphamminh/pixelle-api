...
class StoryboardConfig:
    ...
    image_motion: str = "static"               # Image-to-video motion: "static" or "ken_burns"
    image_motion_strength: str = "subtle"      # Ken Burns strength: "subtle", "medium", or "strong"
    image_motion_preset: str = "auto"          # Ken Burns preset: "auto" rotates scene motions

    # Subtitle rendering
    subtitle_mode: str = "scene"               # "scene" uses template text, "none" hides text, "phrase" burns timed chunks
    subtitle_style: str = "comic_tiktok"       # Phrase subtitle style
    subtitle_words_per_chunk: int = 4          # Target words per timed subtitle chunk
