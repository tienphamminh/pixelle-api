    ...
    **Note**: May timeout for large videos. Use `/generate/async` instead.
    ...
    try:
        ...
        video_params = {
            ...
            "manual_storyboard": request_body.manual_storyboard,
            ...
            "image_motion_preset": request_body.image_motion_preset,
            "subtitle_mode": request_body.subtitle_mode,
            "subtitle_style": request_body.subtitle_style,
            "subtitle_words_per_chunk": request_body.subtitle_words_per_chunk,
